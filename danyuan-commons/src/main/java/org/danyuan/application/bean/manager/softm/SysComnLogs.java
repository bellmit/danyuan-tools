...
/**
 * 文件名 ： SysComnLogs.java 包 名 ：
 * tk.ainiyue.danyuan.application.common.config.syslog 描 述 ： TODO(用一句话描述该文件做什么)
 * 机能名称： 技能ID ： 作 者 ： Administrator 时 间 ： 2018年4月9日 下午2:18:23 版 本 ： V1.0
 */
@Entity
@Table(name = "sys_comn_logs")
@DynamicInsert
@DynamicUpdate
public class SysComnLogs extends BaseEntity implements Serializable {
	...
	/**
	 * 方法名 ： getMethod 功 能 ： 返回变量 method 的值
	 * 
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setMethod 功 能 ： 设置变量 method 的值
	 */
	...
	/**
	 * 方法名 ： getClassMethod 功 能 ： 返回变量 classMethod 的值
	 * 
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setClassMethod 功 能 ： 设置变量 classMethod 的值
	 */
	...
	/**
	 * 方法名 ： getClassName 功 能 ： 返回变量 className 的值
	 * 
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setClassName 功 能 ： 设置变量 className 的值
	 */
	...
	/**
	 * 方法名 ： getRequestLong 功 能 ： 返回变量 requestLong 的值
	 * 
	 * @return: Integer
	 */
	...
	/**
	 * 方法名 ： setRequestLong 功 能 ： 设置变量 requestLong 的值
	 */
	...
	/**
	 * 方法名 ： getMessage 功 能 ： 返回变量 message 的值
	 * 
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setMessage 功 能 ： 设置变量 message 的值
	 */
	...
	/**
	 * 方法名 ： getParamList 功 能 ： 返回变量 paramList 的值
	 * 
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setParamList 功 能 ： 设置变量 paramList 的值
	 */
	...
	/**
	 * 方法名 ： getTableName 功 能 ： 返回变量 tableName 的值
	 * 
	 * @return: String
	 */
	...
	/**
	 * 方法名 ： setTableName 功 能 ： 设置变量 tableName 的值
	 */
